...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql10 = "SELECT IF(EXISTS(SELECT 1 FROM faculty WHERE email_id = '$emailID'), 'true', 'false') AS result;";
    $stmt10 = mysqli_prepare($conn, $sql10);
    mysqli_stmt_execute($stmt10);
    $result10 = mysqli_stmt_get_result($stmt10);
    $row10 = mysqli_fetch_assoc($result10);

    $sql11 = "SELECT IF(EXISTS(SELECT 1 FROM faculty WHERE f_id = '$fid'), 'true', 'false') AS result;";
    ...
    if ($row10["result"] == "true") {
        ...
        $sql = "INSERT INTO faculty (f_id, password, fac_name, email_id, fac_room_no, did)
                VALUES ('$fid','$pass','$fname','$emailID','$roomNumber','$did');";
...
<head>
    ...
    <title>Faculty Register - <?php echo $_SESSION['name'] ?></title>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-description"> Faculty Information</h3>
                                    <form class="admin_register.php" method="POST">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label for="id" class="col-sm-3 col-form-label">Faculty ID</label>
                                                    <div class="col-sm-9">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label for="did" class="col-sm-3 col-form-label">Department ID</label>
                                                    <div class="col-sm-9">
