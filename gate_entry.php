...
$sql = "SELECT entry_time, DATE(entry_time) AS date, TIME(entry_time) AS time
      FROM gate_entry
      WHERE roll_no=?;";
          ...
          <div class="row">
            ...
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-white" style="height: 200px;">
                <div class="card-body">
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  <h2 class="font-weight-normal mb-3">Monthly Late <i class="mdi mdi-calendar-clock mdi-30px float-right"></i>
                  </h2>
            ...
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-success card-img-holder text-white" style="height: 200px;">
                <div class="card-body">
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  <h2 class="font-weight-normal mb-3">Weekly Late <i class="mdi mdi-calendar-clock mdi-30px float-right"></i>
                  </h2>
                      ...
                      if (mysqli_stmt_execute($stmt)) {
                        ...
                        if (mysqli_num_rows($result) > 0) {
                          ...
                          while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            //   $lateDuration = gmdate('H:i:s', $diffSeconds - 12 * 3600);
                            // }
                            // else
                            ...
                            echo "<tr>";
                            echo "<td>" . $sno . "</td>";
                            echo "<td>" . $dateComponent . "</td>";
                            echo "<td>" . $timeComponent . "</td>";
