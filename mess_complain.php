...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  if ($category = "Food issue")
    $complainID = "C001";
  if ($category = "Hygein")
    $complainID = "C002";
  if ($category = "Unclean plates")
    $complainID = "C003";
  ...
  if ($stmt) {
    ...
    if (mysqli_stmt_execute($stmt)) {
      header("location:http://localhost/Dashboard/mess_complain.php");
    } else {
...
<head>
  ...
  <title>Mess Complain - <?php echo $_SESSION['name'] ?></title>
  <!-- plugins:css -->
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" id="category" name="category" required>
                        ...
                        <option value="Hygein">Hygein</option>
                        <option value="Unclean plates">Unclean plates</option>
